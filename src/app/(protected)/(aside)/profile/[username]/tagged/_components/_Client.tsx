...
import { ProfileZone } from "../../_components";
...
export default function SuspenseWrapper({
  ...
  return (
    ...
    >
      <ProfileMomentsPage username={username} initialRes={initialRes} />
    </Suspense>
  );
}

function ProfileMomentsPage({ username, initialRes }: ProfileMomentsProps) {
